define(["exports"], function (_exports) {
  ...
  var reactdescription = function reactdescription() {
    ...
    var reactDescriptionDesign = document.createElement('div'); //styles
    ...
    reactDescriptionDesign.style.borderRadius = '3px'; //content

    reactDescriptionDesign.innerHTML = desciptionContent; //returning design/element of this component
